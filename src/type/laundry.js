                ...
                <CardItem
                        ...
                        <Col style={{
                            ...
                            <Row style={{ margin: 5 }}>
                                <Col size={20} style={{ justifyContent: "center", alignItems: "center" }}>
                                    <LottieView
                                        source={require('../assets/animation/lottie/3138-washing-machine.json')}
                                        style={{ width: 50, height: 50 }}
                                        ref={animation => {
                                            this.laundry = animation;
                                        }}
                                    />
                                </Col>
                                <Col size={80} style={{
                    ...
                    <Grid style={{ margin: 10 }}>
                        <Col
                            ...
                            <TouchableOpacity onPress={() => this.CleanLaundry()}>
                                <LottieView
